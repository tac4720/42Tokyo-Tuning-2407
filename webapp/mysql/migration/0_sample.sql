...
ALTER TABLE orders ADD INDEX index_orders_status(status);
...
ALTER TABLE locations ADD INDEX index_location_tow_truck_id(tow_truck_id);
ALTER TABLE locations ADD INDEX index_location_timestamp(timestamp);

ALTER TABLE nodes ADD INDEX index_name(name);
ALTER TABLE nodes ADD INDEX area_id(area_id);

ALTER TABLE tow_trucks ADD INDEX index_area_id(area_id);
ALTER TABLE tow_trucks ADD INDEX index_tow_trucks_status(status);

ALTER TABLE edges ADD INDEX index_weight(weight);

DROP INDEX order_id ON completed_orders;
DROP INDEX tow_truck_id ON completed_orders;
